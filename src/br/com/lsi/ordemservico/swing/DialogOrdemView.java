 ...
 * @author Allan
 */
public class DialogOrdemView extends javax.swing.JDialog {

 private Fachada facade = new Fachada();
    public DialogOrdemView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        uJPanelImagem4.setImagem(new java.io.File("C:\\Users\\Allan\\Documents\\NetBeansProjects\\OrdemServico\\src\\br\\com\\lsi\\ordemservico\\imagens\\2.jpg"));
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogOrdemView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogOrdemView dialog = new DialogOrdemView(new javax.swing.JFrame(), true);
